        ...
        <div id="grid_view" class="tab-pane fade show active" role="tabpanel">
            <div class="objects-grid gutters-sm mt-3 offset-md-1">
                <div class="form-row col-md-11" >
                    ...
                    <!-- fim não aparecer no mobile -->
                    <div class="object-vertical col-xl-3 col-md-12 mb-4" >
                        <div class="card">
                            <div class="card-header card-header-planos">
                                <div class="teste2 mx-auto d-block">
                                    <br>
                                    <spam class="cardtitle3">COMBO SIMPLES</spam>
                                    <spam class="cardtitle2 sm-25"> 25 MEGA </spam>
                                    <div class="mt-3">
                    ...
                    <div class="object-vertical col-xl-3 col-md-12 mb-4" >
                        <div class="card">
                            ...
                            <div class="card-body text-primary card-body-planos">
                                <spam><i class="fa fa-check fa-lg" aria-hidden="true"></i> 50 MEGA <spam class="cardtitle5"> Upload</spam><hr></spam>
                                <a>
                                    <img src="<?= $uri ?>/node_modules/img/planos/wifi-mini2.png"  class="btn-planos-home-service" >
                                </a>
                                <hr>
                    ...
                    <div class="object-vertical col-xl-3 col-md-12 mb-4" >
                        <div class="card">
                            ...
                            <div class="card-body text-primary card-body-planos">
                                <spam>
                                    <i class="fa fa-check fa-lg" aria-hidden="true"></i> 200 MEGA <spam class="cardtitle5"> Upload</spam><br>
                                </spam>
                                <hr>
                                <a>
                                    <img src="<?= $uri ?>/node_modules/img/planos/wifi-mini2.png"  class="btn-planos-home-service" >
                                    <a class="" href="<?= $uri ?>/views/homeService.php"> 
                                        <img class="btn-planos-home-service pl-3 pr-3" src="<?= $uri ?>/node_modules/img/logo/logo-home-service-azul-mini.png" >
                                    </a>
                                </a>
                                <hr>
                                <?php include("views/comboAlto.php")?>
...
<?php include("views/modalPlanos/watch.php")?>
  <?php include("views/modalPlanos/logteltv.php")?>
