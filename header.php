  ...
  <body>
    ...
    <nav class="navbar  navbar-expand-lg  navbar-light navegacao">
      <div class="container">
          ...
          <spam class="pt-2 pb-2 pl-3 pr-3">
          ...
          <div id="menu" class="collapse navbar-collapse ml-2" style="font-size:13px;">
            <ul class="navbar-nav links  ">
              <li class="nav-item">
                <a class="nav-link" href="<?= $uri ?>">PARA VOCÊ</a>
              </li>
              <li class="nav-item">
                <spam class="line-left">
                <a  class="nav-link"  href="<?= $uri ?>/construcao.php">PARA SUA EMPRESA</a>
              </li>
              <li class="nav-item">
                <spam class="line-left">
                <a target="_blank" class="nav-link dropdown-toggle text-danger" href="http://www.logtelplay.com.br/">LOGTEL PLAY <i class="fa fa-play-circle-o" aria-hidden="true"></i></a>
              </li> 
            </ul>
          </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-light navegacao ">  
      <div class="container">
          ...
          <div id="menu" class="collapse navbar-collapse ml-2">
